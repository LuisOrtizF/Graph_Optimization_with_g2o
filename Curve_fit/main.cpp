...
class VertexExponential: public g2o::BaseVertex<3, Eigen::Vector3d>
{
    public:
...
class EdgePointOnExponential : public g2o::BaseUnaryEdge<2, Eigen::Vector2d, VertexExponential>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW

        //Default constructor
        EdgePointOnExponential()
        {
        ...
        void computeError()
        {
            ...
            const VertexExponential* v = static_cast<const VertexExponential*>(_vertices[0]);
            ...
            double yp = a * exp( b * measurement().x()) + c;
...
int main(int argc, char** argv)
{
    ...
    //-Add vertices
    VertexExponential* vertices = new VertexExponential();
    vertices->setId(0);
    ...
    for(size_t i = 0; i < num_obs; i++)
    {
        EdgePointOnExponential* e = new EdgePointOnExponential;
